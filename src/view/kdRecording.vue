      ...
      <ul>
        <li v-for="(item,index) in goodsList" :key="item.id">
          <p class="payment-li-number">
            ...
            <span v-if="item.orderType == '2'">待发达</span>
          </p>
          <div :class="item.orderType == '2' ? 'none': 'payment-li-des'">
          ...
          <!--          </div>-->
          <div class="payment-btu" v-if="item.orderType == '1'">
            <!--            <span @click="showToast">取消订单</span>-->
            <span>付款</span>
          </div>
          <div class="payment-btu" v-if="item.orderType == '2'">
          </div>
        </li>
      </ul>
    </div>
